...
const Filestab = () => {
  ...
  return (
    <div className='bg-drk01 flex justify-start items-center'>
      <div className="flex gap-2 justify-center items-center text-green-500 text-sm border-gray-800 px-6 cursor-pointer h-full border-1 hover:bg-drk00 focus-visible::bg-drk00">
        <p>
          <img src={ricon} alt="" width={18} height={18} />
        </p>
        <Link to='/home'>home.jsx</Link>
      </div>
      <div className="flex gap-2 justify-center items-center text-green-500 text-sm border-gray-800 px-6 cursor-pointer h-full border-1 hover:bg-drk00">
        <p>
